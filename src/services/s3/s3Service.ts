...
export default class S3Service implements IS3Service.IS3ServiceAPI {
    ...
    public uploadFile = async (req: IS3Service.IUploadRequest, res: unknown) => {
        ...
        try {
            ...
            let result: s3Interface = await this.s3Store.uploadFile(payload);
    ...
    public getFiles = async (req: IS3Service.IGetFilesRequest, res: unknown) => {
        ...
        try {
            ...
            let result: s3Interface[] = await this.s3Store.getFiles(payload);
            let filename = result[0].filepath;
    ...
    public deleteFile = async (req: IS3Service.IDeleteFilesRequest, res: unknown) => {
        ...
        try {
            ...
            let result: s3Interface = await this.s3Store.delete(payload);
